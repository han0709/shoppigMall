...
public class AdminProductUpdateAction implements Action {
  ...
  public void execute(HttpServletRequest request, HttpServletResponse response)
    ...
    String useynn = multi.getParameter("useyn");
    String bestynn = multi.getParameter("bestyn");
    if(useynn==null) {
    	useynn = "n".toString();
    }else {
    	useynn = "y".toString();
    ...
    productVO.setUseyn(useynn);
    productVO.setBestyn(bestynn);
    ...
    response.sendRedirect(url+"&tpage="+tpage);
  }
}
