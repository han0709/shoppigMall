...
public class ProductDAO {
  ...
  public String pageNumber(int tpage, String name) {
    ...
    if (start_page > view_rows) {
      ...
      str +="<a href='NonageServlet?command=admin_product_list&tpage="+ (start_page - 1) + "&key=<%=product_name%>'>&lt;</a>&nbsp;&nbsp;";
    }
  ...
  public ArrayList<ProductVO> listProduct(int tpage, String product_name) {
    ...
    try {
      ...
      //ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE 는 아래 absolute를 사용하기 위함임.
